...
# TODO: need truely history data, this is the Mock API
# TODO: need check current bar time 
def get_current_price(security):
    # get the close of 1 minute bar
...
def get_price(security, count=None, start_bar_time=None, end_bar_time=None, frequency="5m"):
    ...
    if count is not None:
        # count bar before end_bar_time（except end_bar_time)
